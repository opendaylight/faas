...
public class UlnDatastoreApi {
    ...
    public static void attachEndpointToSubnetAndSubmitToDs(EndpointLocationBuilder epLocBuilder, Uuid faasSubnetId,
    ...
    public static void attachAndSubmitToDs(Uuid firstId, Uuid secondId, Uuid tenantId,
            Pair<LocationType, LocationType> nodeTypes) {
        attachAndSubmitToDs(firstId, secondId, tenantId, nodeTypes, null);
    }
    ...
    public static void attachAndSubmitToDs(Uuid firstId, Uuid secondId, Uuid tenantId,
        ...
        synchronized (UlnDatastoreApi.class) {
            ...
            attachAndSubmitToDs(first, second, secGroupRules);
        }
    }

    public static void attachAndSubmitToDs(DataObject first, DataObject second) {
        attachAndSubmitToDs(first, second, null);
    }

    public static void attachAndSubmitToDs(DataObject first, DataObject second, Pair<Uuid, Uuid> secGroupRules) {
