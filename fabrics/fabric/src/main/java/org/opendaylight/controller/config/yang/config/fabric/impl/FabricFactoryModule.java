...
public class FabricFactoryModule extends AbstractFabricFactoryModule {
    public FabricFactoryModule(ModuleIdentifier identifier, DependencyResolver dependencyResolver) {
        super(identifier, dependencyResolver);
    }

    public FabricFactoryModule(ModuleIdentifier identifier,
            DependencyResolver dependencyResolver,
            FabricFactoryModule oldModule,
