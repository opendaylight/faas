...
//        Map<String, AdapterBridgeDomain> bdCache = ctx.getBdCache();
//        if ( bdCache.containsKey(newRec.getId()) )
//            return;
//
//        AdapterBridgeDomain adapterBridgeDomain = new AdapterBridgeDomain()
//
//        bdCache.put(newRec.getId(), newRec);
//
        Long dpidLong = ctx.getDpid();
