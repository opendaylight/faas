...
import org.opendaylight.faas.fabrics.vxlan.adapters.ovs.utils.ServiceHelper;
...
public abstract class AbstractServiceInstance {
    ...
    private volatile OvsSouthbound southbound;

    private Service service;

    public AbstractServiceInstance(Service service) {
        //yaoziyang: to be implement
    ...
    protected void setDependencies(final ServiceReference ref, AbstractServiceInstance serviceInstance) {
        ...
        this.southbound =
                (OvsSouthbound) ServiceHelper.getGlobalInstance(OvsSouthbound.class, serviceInstance);
    }
