...
public class PipelineArpHandler extends AbstractServiceInstance {
    ...
    public PipelineArpHandler(Service service) {
        super(service);
    }

    public PipelineArpHandler() {
        super(Service.ARP_HANDlER);
    }

    public Status programStaticArpEntry(Long dpid, String segmentationId, String macAddressStr, InetAddress ipAddress,
            Action action) {
        ...
        if (ipAddress instanceof Inet6Address) {
            ...
            LOG.debug(
                    "ipv6 address case is not implemented yet. dpid {} segmentationId {} macAddressStr, ipAddress {} action {}",
        ...
        MatchUtils.createArpDstIpv4Match(matchBuilder,
                MatchUtils.iPv4PrefixFromIPv4Address(ipAddress.getHostAddress()));
