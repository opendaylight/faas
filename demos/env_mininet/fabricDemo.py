...
BRIDGE_REF_P="/network-topology:network-topology/network-topology:topology[network-topology:topology-id='ovsdb:1']/network-topology:node[network-topology:node-id='%s/bridge/%s']"
TP_REF_P="/network-topology:network-topology/network-topology:topology[network-topology:topology-id='ovsdb:1']/network-topology:node[network-topology:node-id='%s/bridge/%s']/network-topology:termination-point[network-topology:tp-id='%s']"
...
def rpc_register_endpoint_data(host):
    ...
    return {
        "input" : {
            ...
            "location" : {
                "node-ref": BRIDGE_REF_P % (NODE_ID_OVSDB, bridge),
                "tp-ref": TP_REF_P % (NODE_ID_OVSDB, bridge, port),
