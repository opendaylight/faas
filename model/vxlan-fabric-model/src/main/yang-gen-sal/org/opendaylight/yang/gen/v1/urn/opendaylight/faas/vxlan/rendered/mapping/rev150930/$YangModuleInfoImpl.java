...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "fabric-vxlan-rendered-mapping";
    private final String namespace = "urn:opendaylight:faas:vxlan:rendered:mapping";
    private final String revision = "2015-09-30";
    private final String resourcePath = "/META-INF/yang/fabric-vxlan-rendered-mapping.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.faas.fabric.rev150930.$YangModuleInfoImpl.getInstance());
