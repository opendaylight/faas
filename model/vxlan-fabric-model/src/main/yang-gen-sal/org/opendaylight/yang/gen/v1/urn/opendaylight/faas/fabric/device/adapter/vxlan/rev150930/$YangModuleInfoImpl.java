...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "fabric-vxlan-device-adapter";
    private final String namespace = "urn:opendaylight:faas:fabric:device:adapter:vxlan";
    private final String revision = "2015-09-30";
    private final String resourcePath = "/META-INF/yang/fabric-vxlan-device-adapter.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.faas.fabric.capable.device.rev150930.$YangModuleInfoImpl.getInstance());
